...
public class Contact {
    ...
    private String phoneNumber_fax;
    ...
    public String getPhoneNumber_fax() {
        return phoneNumber_fax;
    }

    public void setPhoneNumber_fax(String phoneNumber_fax) {
        this.phoneNumber_fax = phoneNumber_fax;
    }
